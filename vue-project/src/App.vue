...
<template>
  ...
  <p>{{ 1 + 3 }}</p>
  <p>{{ (7 < 8) ? 'Si' : 'No' }}</p>
      <p>Mi Variable {{ miVariable }}</p>
      <p>Mi Variable + 4: {{ miVariable + 4 }}</p>

      <p>Mivariable2: {{ miVariable2 }}</p>
      <p>Mivariable2 a: {{ miVariable2.a[0] }}</p>
      <p>Mivariable2 b: {{ miVariable2.b }}</p>
      <p>Mivariable2 b: {{ miVariable2['b'] }}</p>
      <p>Funcion: {{ miVariable3 + " " + miFuncion() }}</p>
      <br>
